                ...
                <h1 class="text-login">Sign Up Here</h1>
                 ...
                 <form action="signup" method="POST"> 
                     <div class="form-group">
                      ...
                      <input name="uname" type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input name="mobNo" type="tel" class="form-control" id="mobile number" aria-describedby="mobile number help" placeholder="Enter mobile number">
                    </div>
